    ...
    <div class="content-header">
      <div class="space-x-1">
        ...
        <button type="button" class="btn btn-alt-secondary" data-toggle="layout" data-action="header_search_on">
          <i class="fa fa-fw opacity-50 fa-search"></i> <span class="ms-1 d-none d-sm-inline-block">Recherche</span>
        </button>
      </div>
      <div class="space-x-1">
        <div class="dropdown d-inline-block">
          <button type="button" class="btn btn-alt-secondary" id="page-header-user-dropdown" data-bs-toggle="dropdown"
            ...
            <span class="d-none d-sm-inline-block">Administrateur</span>
...
<!--              <div role="separator" class="dropdown-divider"></div>-->
              ...
              <router-link class="dropdown-item" :to="{ name: 'EnterpriseForm' }" data-toggle="layout" data-action="side_overlay_toggle">
